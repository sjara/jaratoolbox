...
firstPass = True #FIX ME: fix this hack solution to not printing maxZFreq the first time this for loop runs
for cellID in range(0,numOfCells):
    ...
    if (behavSession != oneCell.behavSession):
        ...
        maxZFreq = [[] for i in range(numberOfFrequencies)]
    ...
    for Frequency in range(numberOfFrequencies):
        ...
        maxZFreq[Frequency].append(maxZ)
        #text_file.write("%s" % maxZ)
