...
for cellID in range(0,numOfCells):
	...
	eventOnsetTimes = eventTimes[eventOnset == 1] #This gives only the times of the onset of the channel you want
        ...
        correctedSideInTimes = np.empty(len(sideInTimes))
        ...
        for indTime,soundTime in enumerate(soundStartTimes):
            correctedSideInTimes[indTime] = sideInTimes[indTime] + (eventOnsetTimes[indTime] - soundTime)
            

        sideInTimesTrials1 = correctedSideInTimes[trialsToUse1==1]
        sideInTimesTrials2 = correctedSideInTimes[trialsToUse2==1]

	eventOnsetTimesTrials1 = sideInTimesTrials1
	eventOnsetTimesTrials2 = sideInTimesTrials2
	...
	fulloutputDir = outputDir+subject+'/'+'cluster_sideIn'+'/'
