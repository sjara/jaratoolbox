...
def billyplot(spikeTimesFromEventOnset, sortedIndexForEachSpike,meanSpikesEachFrequency,possibleFreq,responseRange,tetrodeID):
    ...
    #tickLabels = ["%0.2f" % (possibleFreq[indf]) for indf in range(len(possibleFreq))]
...
numTetrodes = 8
behaviorDir='/home/jarauser/data/behavior/billy/'
fullbehaviorDir = behaviorDir+subject+'/'
behavName = subject+'_tuning_curve_'+day+'.h5'
#behavName = subject+'_laser_tuning_curve_'+day+'.h5'
...
for tetrodeID in range(1,numTetrodes+1):
    ...
    #billyplot(spikeTimesFromEventOnset, sortedIndexForEachSpike,meanSpikesEachFrequency,possibleFreq)


ft = extraplots.FlipThrough(billyplot,alldata)
