'''
Modified from Billy's file. Plots number of significantly and non-significantly modulated cells from modulation index of -1 to +1. Only using good quality cells (all_cells file only contain good quality cells). Generates responsiveCellDB and modulatedCellDB (without considering ISI)
'''
...
print responsiveCellDB, modulatedCellDB
...
plt.title('%s cells without checking ISI, %s cells significantly modulated' %(cellNum,sigNum))
