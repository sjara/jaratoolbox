...
site1 = exp1217.add_site(depth=2420, tetrodes=[1,2,3,4,5,6,7,8]) 
...
sitefuncs.lan_2afc_ephys_plots_each_block_each_type(site1, 'site1', main2afcind=4, tetrodes=[5,8],trialLimit=[0,1509],choiceSide='left')
sitefuncs.lan_2afc_ephys_plots_each_block_each_type(site1, 'site1', main2afcind=4, tetrodes=[5,8],trialLimit=[0,1509],choiceSide='right')
