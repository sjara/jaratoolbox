...
exp = cellDB.Experiment(animalName='adap011', date ='2015-01-06', experimenter='lan', defaultParadigm='laser_tuning_curve') 
...
#sitefuncs.lan_2afc_ephys_plots_each_type(site1, 'site1', main2afcind=4, tetrodes=[1,2,3,5,8],trialLimit=[])
