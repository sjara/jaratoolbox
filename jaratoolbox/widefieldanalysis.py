...
class WidefieldAverage:
    ...
    def show_merged_signal_change(self, clim=None, weights=None):
        """
        ...
        Args:
            clim (tuple): Color limits for the individual frequency images (vmin, vmax). 
                If None, uses ±3 standard deviations of the normalized data.
        ...
        for channel in range(3):
            ...
            merged_image[mask, channel] = max_values[mask]
