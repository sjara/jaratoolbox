...
countTimeRange = [0.1,0.2] #time range in which to count spikes for modulation index######################

clusNum = 12 #Number of clusters that Klustakwik speparated into
numTetrodes = 8 #Number of tetrodes


stimulusRange = [0.1,0.2] # The time range that the mouse is moving after the sound is presented#################
...
nameOfFile = 'modIndex_afterSound'
